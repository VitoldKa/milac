...
const char smtp_ehlo_replay[] = "250-mila11.vitou.com\r\n250-8BITMIME\r\n250-PIPELINING\r\n250 SIZE 157286400\r\n"; //
const char smtp_helo_replay[] = "250 mila11.vitou.com\r\n"; //
...
// 	printf("%s\n", asctime (timeinfo));
	...
	const char outbuf[] = "220 mila11.vitou.com ESMTP Postfix (Ubuntu)\r\n";
