...
void* doSomeThing(void *arg)
{
	...
	const char outbuf[] = "220 mila7.vitou.com ESMTP Postfix (Ubuntu)\r\n";
...
//			{
				const char loutbuf[] = "250-mila7.vitou.com\r\n250-8BITMIME\r\n250 SIZE 157286400\r\n";
...
//			}
		...
		if(strncmp(buffer, "rcpt to:", 8)==0)
		{
			...
			{
				if( ( strcmp(buffer+8, "<vitold.ka@mila6.vitou.com>\r\n")==0) ||
					( strcmp(buffer+8, "<vitold.ka.3@mila6.vitou.com>\r\n")==0) ||
					( strcmp(buffer+8, "<vitold.ka@mila7.vitou.com>\r\n")==0) ||
					( strcmp(buffer+8, "<vitold.ka.3@mila7.vitou.com>\r\n")==0) ||
					( strcmp(buffer+8, "<vitold.ka@mila8.vitou.com>\r\n")==0) ||
					( strcmp(buffer+8, "<vitold.ka.3@mila8.vitou.com>\r\n")==0) ||
					( strcmp(buffer+8, "<vitold.ka@mila-i1.vitou.com>\r\n")==0)
