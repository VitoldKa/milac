...
//				chunk = curl_slist_append(chunk, "apns-topic: com.10-sor.silentclock.voip");
		//		curl_easy_setopt(curl, CURLOPT_VERBOSE, 1L);
				...
				if(strcmp(to, "<vitold.ka@mila-i1.vitou.com>\r\n")==0)
